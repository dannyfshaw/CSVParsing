...
public class CsvFileWriter {
	...
	public static void main(String[] args) {
		CsvFileWriter run = new CsvFileWriter();
		String fileName = "C:\\Development\\Spring boot workspace\\corprotex\\src\\main\\resources\\fileName.csv";
		run.writeCsvFile(fileName);
	}
}